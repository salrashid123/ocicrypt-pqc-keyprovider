module github.com/salrashid123/ocicrypt-pqc-keyprovider/plugin
...
require (
	...
	github.com/salrashid123/go-pqc-wrapping v0.0.73
...
require (
	...
	cloud.google.com/go/compute v1.56.0 // indirect
